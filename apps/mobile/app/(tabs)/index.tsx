...
/**
 * Inventory — the app's home: every item ever logged, across every batch,
 * searchable and sortable. Rows are deliberately identical to the batch
 * dashboard's so the same piece looks the same wherever you meet it.
 */
