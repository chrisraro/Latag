    ...
    <View className="flex-1 bg-bg px-4" style={{ paddingTop: insets.top + 8 }}>
      ...
      {session.type === "selector" ? (
        <View style={{ paddingTop: 12, paddingBottom: 8 }}>
          <Text style={{ fontFamily: FONT.medium }} className="text-[13px] text-inkfaint">PROJECTED PROFIT</Text>
          ...
          <View className="mt-2 flex-row gap-5">
            <View>
              ...
              <Text className="text-[12px] text-inkfaint">realized</Text>
            </View>
            <View>
              <Text style={{ fontFamily: FONT.bold, fontVariant: ["tabular-nums"] }} className="text-[17px] text-ink">{all.length}</Text>
              <Text className="text-[12px] text-inkfaint">items</Text>
            </View>
            <View>
              ...
              <Text className="text-[12px] text-inkfaint">sold</Text>
            </View>
          </View>
        </View>
      ) : (
        <View style={{ paddingTop: 6, paddingBottom: 2 }}>
          <Text style={{ fontFamily: FONT.medium }} className="text-[13px] text-inkfaint">CAPITAL RECOVERED</Text>
          ...
          <Text style={{ fontFamily: FONT.text, fontVariant: ["tabular-nums"], marginTop: 6, paddingTop: 8, paddingBottom: 2 }} className="text-[12px] text-inkfaint">
