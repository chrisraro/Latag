...
- [ ] Pricing: change the price in /admin → /pro and /account Free card show the new figure
...
- [ ] Delete a TEST account (create one with a second email first) → sign-in works again with that email as a fresh account
